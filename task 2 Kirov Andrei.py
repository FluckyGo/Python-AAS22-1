...
new_in = str(input('[+] Введи марку или модель:  '))
for id in cars_list:
    if new_in in id:
        print(f'Вот что я нашел {id}')
...
#while True:
#    x = cars_dict.get(input('[+] Введи марку и модель:  '),'Введите другое значение, совпадений нет.')
#    print(x)
...
#data_input = input('[+] Введи марку и модель или год выпуска, номер кузова, объем двигателя, тип двигателя:  \n')
#for model, prod_data, code_chassis, engine_capacity, engine_type in cars_set:
#    if data_input == model or code_chassis or engine_capacity or engine_type:
#       print(model, prod_data, code_chassis, engine_capacity, engine_type)
#    else:
#        print('Введите другое значение, совпадений нет.')
...
# cars_set1 = {'Nissan Skyline, 1999, R34, 2.6, R6','Honda NSX, 2005, C32, 3.0, V6','Mercedes-Benz ML63, 2008, W164, 6.3 ,V8','Toyota Century, 1999, G50, 5.0, V12'}
#
# for x in cars_set1:
#     print(x)
#     if 'Nissan' in x:
